                  ...
                  <div class="card-body d-flex flex-column">
                      ...
                      <form action="cart.php" method="POST">
                          ...
                          <div class="d-grid gap-2 mt-auto">
                              <button type="submit" name="add_to_cart" class="btn btn-dark rounded-pill py-2 fw-bold">
                                  Add to Cart
                              </button>
                              <a href="product_details.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-dark rounded-pill py-2 small">
                                  Explore Spice
                              </a>
                          </div>
                      </form>
