...
<head>
    ...
    <title>Coffee & Beverages - Serandib Twist</title>
    <style>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="d-flex align-items-center gap-3">
        <form class="d-flex" action="search.php" method="GET">
          <input class="form-control me-2 rounded-pill" name="query" type="search" placeholder="Search coffee..." required>
...
<section class="py-5" style="background-color: #fdfaf5;">
  <div class="container">
    <h1 class="text-center mb-2" style="color: #3d2b1f; font-family: 'Playfair Display', serif;">Serandib Twist Coffee</h1>
                  ...
                  <div class="card-body d-flex flex-column">
                      ...
                      <form action="cart.php" method="POST">
                          ...
                          <div class="d-grid gap-2 mt-auto">
                              ...
                              <a href="product_details.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-dark rounded-pill py-2 small">Explore More</a>
                          </div>
                      </form>
                  </div>
              </div>
